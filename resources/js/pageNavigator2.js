...
var PageNavigator2 = function( target, fnc, options ) {
...
$.extend(PageNavigator2.prototype, {
    init: function(){
        ...
        if( totalPageCount > 0 ){
            ...
            if( this.settings.firstVisible ){
               /* this.firstNode.data("pageNo", 1).click(function(e){
                    e.preventDefault();
                    PageNavigator2.callbackFunc.apply(PageNavigator2, [ $(this).data("pageNo") ]);
                });
              */


                if( this.settings.linkNodeType.toUpperCase() == "A" )
                    this.firstNode.attr({ href:"#none", alt:1, title:"처음"});
            ...
            if( this.settings.prevVisible ){
                ...
                if( this.settings.linkNodeType.toUpperCase() == "A" )
                    this.prevNode.attr({ href:"#none", alt:pageNo, title:("이전" + blockCount + "") });
            ...
            for(var i=startNo; i<endNo; i++){
                ...
                if( i == currentPageNo ){
                    ...
                    if( this.settings.linkNodeType.toUpperCase() == "A" )
                        $node.attr({ href:"#nonenone", alt:i, title:i });
                }
            ...
            if( this.settings.nextVisible ){
               ...
               /* this.nextNode.data("pageNo", pageNo).click(function(e){
                ...
                if( this.settings.linkNodeType.toUpperCase() == "A" )
                    this.nextNode.attr({ href:"#none", alt:pageNo, title:("다음 " + blockCount + "") });
            ...
            if( this.settings.lastVisible ){
                ...
                if( this.settings.linkNodeType.toUpperCase() == "A" )
                    this.lastNode.attr({ href:"#none", alt:pageNo, title:"마지막" });
