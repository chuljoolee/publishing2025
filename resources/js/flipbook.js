...
//                    b.horizontal ? (a.jq_el.css("top", "0px"), a.jq_el.css("left", b.page_width + "px")) : (a.jq_el.css("top", b.page_height + "px"), a.jq_el.css("left", "0px"));
        ...
        d.init_layers = function () {
            for (var b, a, c = 0; c < d.pages.length; c++) b = d.pages[c], a = d.pages.length - c, b.left_positioned ? (b.jq_el.css("z-index", 100 * c), b.jq_el.css("border-radius",
                "0px 5px 5px 0px"), b.prev_handle.show(), b.next_handle.hide()) : (b.jq_el.css("z-index", 100 * a), b.jq_el.css("border-radius", "5px 0px 0px 5px"), b.prev_handle.hide(), b.next_handle.show())
        };
        a.addClass(b.theme);
        (function () {
            var a, c;
        ...
        var c = {
            ...
            RADIX: 10
                ...
                for (var b, a, e, o, j = 0; j < d.list.length; j++)
                    if (b =
                        d.list[j], a = b.prev, b = b.next, "" != a || "" != b) "" == a ? (o = b.number + 1, c.paging.append("<span data-index='" + j + "' data-prev='-1' data-next='" + b.number + "' class='current' style='display: none;'>" + o + "</span>")) : "" == b ? (e = a.number + 1, c.paging.append("<span data-index='" + j + "' data-prev='" + a.number + "' data-next='-1' style='display: none;'>" + e + "</span>")) : (e = a.number + 1, o = b.number + 1, c.paging.append("<span data-index='" + j + "' data-prev='" + a.number + "' data-next='" + b.number + "' style='display: none;'>" + e + " - " + o + "</span>"));
                ...
                //c.paging_ul.css("margin-left", (a.width() - c.paging_ul.width()) / 2); 140627 hwang
                c.slideshow_ul.css("margin-left", (a.width() - c.slideshow_ul.width()) / 2);
                d = c.prev_index;
                e = c.next_index;
                0 < c.prev.length && 0 < c.next.length && (-1 == d ? (c.prev.addClass("prev-btn-off"), c.next.removeClass("next-btn-off")) : -1 == e ? (c.prev.removeClass("prev-btn-off"), c.next.addClass("next-btn-off")) : (c.prev.removeClass("prev-btn-off"),
                    c.next.removeClass("next-btn-off")));
    ...
    e.fn.flipbook.flip = function (b, a) {
        var d = {
            ...
            drag: !1
                ...
                d.animated = f;
                "" == p && void 0 != p && "" != p.prev && "" != p.next ? (b.horizontal ? (g.prev.jq_el.css("width", "0px"), g.prev.jq_el.css("left", 2 * b.page_width + "px")) : (g.prev.jq_el.css("height", "0px"), g.prev.jq_el.css("top", 2 * b.page_height + "px")), c.next.jq_el.css("z-index", 100 * a.pages.length), g.prev.jq_el.css("z-index", 100 * (a.pages.length + 1))) : (b.horizontal ? (p.next.jq_el.css("width",
                    "0px"), p.next.jq_el.css("left", "0px"), p.next.jq_wrapper.css("right", "0px"), c.prev.jq_wrapper.css("right", "0px")) : (p.next.jq_el.css("height", "0px"), p.next.jq_el.css("top", "0px"), p.next.jq_wrapper.css("bottom", "0px"), c.prev.jq_wrapper.css("bottom", "0px")), c.prev.jq_el.css("z-index", 100 * a.pages.length), p.next.jq_el.css("z-index", 100 * (a.pages.length + 1)))
                ...
                g == d.direction.PREV ? b.horizontal ? (a = f.prev.jq_el.offset().left + f.prev.jq_el.width() - a, a = b.flip_duration * a / b.page_width, d.flip_prev(f, h, b.page_width, a, function () {
                    k(g, f, h, "")
                }, !0)) : (a = f.prev.jq_el.offset().top + f.prev.jq_el.height() - c, a = b.flip_duration * a / b.page_height,
                    d.flip_prev(f, h, b.page_height, a, function () {
                        k(g, f, h, "")
                ...
                j = c == d.direction.PREV && "" == f.prev ||
                    c == d.direction.NEXT && "" == l.next;
                m = "" == g.prev && "" == l.next || "" == g.next && "" == f.prev;
                c == d.direction.PREV ? (k = e, c = i, b.horizontal ? (l = k, f.next.jq_el.css("width", e + "px"), f.next.jq_el.css("left", l + "px"), g.prev.jq_el.css("left", l + "px"), m ? (h = b.page_width / 2 - e, a.ul.css("left", h + "px")) : h ? (h = (b.page_width - e) / 2, a.ul.css("left", h + "px")) : j && a.ul.css("left", -e / 2 + "px")) : (l = c, f.next.jq_el.css("height", i + "px"), f.next.jq_el.css("top", l + "px"), g.prev.jq_el.css("top", l + "px"), m ? (h = b.page_height / 2 - i, a.ul.css("top", h + "px")) : h ?
                    (h = (b.page_height - i) / 2, a.ul.css("top", h + "px")) : j && a.ul.css("top", -i / 2 + "px"))) : (k = 2 * (b.page_width - e), c = 2 * (b.page_height - i), b.horizontal ? (g = k, l.prev.jq_el.css("width", e), l.prev.jq_el.css("left", g + "px"), m ? (h = -b.page_width / 2 + e, a.ul.css("left", h + "px")) : h ? (h = (e - b.page_width) / 2, a.ul.css("left", h + "px")) : j && a.ul.css("left", e / 2 + "px")) : (g = c, l.prev.jq_el.css("height", i), l.prev.jq_el.css("top", g + "px"), m ? (h = -b.page_height / 2 + i, a.ul.css("top", h + "px")) : h ? (h = (i - b.page_height) / 2, a.ul.css("top", h + "px")) : j && a.ul.css("top",
                    i / 2 + "px")))
//                console.log(h)
            }, k = function (c, e, g, f) {
                if (c == d.direction.PREV) {
                    ...
                    b.horizontal ? (e.next.jq_el.css("width", b.page_width + "px"), e.next.jq_el.css("left", "0px")) : (e.next.jq_el.css("height",
                        b.page_height + "px"), e.next.jq_el.css("top", "0px"));
                ...
                var f, h;
                g == d.direction.PREV ? (g = !1, f = b.page_width +
                    "px", h = b.page_height + "px") : (g = !0, h = f = "0px");
                for (var i = c; i <= e; i++)
                    if (0 <= i && i < a.pairs.list.length) {
                        c = a.pairs.list[i];
        ...
        d.flip_next = function (a, l, g, f, h, i) {
            ...
            j = {
                ...
                complete: function () {
                    d.animated = !1;
                    n = !0 == b.horizontal && g >= b.page_width || !1 == b.horizontal &&
                        g >= b.page_height;
                    e.isFunction(h) && i && h();
        ...
        d.next = function () {
            ...
            b.horizontal ? d.flip_next(c, e, b.page_width, b.flip_duration, "", !1) : d.flip_next(c, e, b.page_height,
                b.flip_duration, "", !1)
        };
        d.prev = function () {
        ...
        (function () {
            for (var j, l, g, f, h = 0; h < a.pages.length; h++) j = a.pages[h], new e.fn.flipbook.drag(b, j.prev_handle, function (b) {
                if (!d.animated && (l = a.pairs.get_prev_pair(), g = a.pairs.get_current_pair(), "" != l && "" != l.next)) d.drag || c(l, g, "", !1), d.drag = !0, i(b.pageX, b.pageY,
                    d.direction.PREV, g, l, "")
            }, function (a) {
        ...
        (function () {
            ...
            0 < a.controls.play.length &&
                a.controls.play.click(function () {
...
(function (e) {
    e.fn.flipbook.pairs = function (b, a) {
        ...
        d.update_current_index = function (a) {
            for (var b, e = 0; e < d.list.length; e++)
                if (b = d.list[e], b.prev == a.prev && b.next == a.next) {
                    d.current = e;
                    break
                }
        };
        ...
        d.get_pair = function (c) {
            ...
            if (0 <= c && c < a.length)
                for (var n =
                    0; n < d.list.length; n++)
                    if (e = d.list[n], e.prev.number == c || e.next.number == c) {
                        b = e;
                        break
                    }
            return b
